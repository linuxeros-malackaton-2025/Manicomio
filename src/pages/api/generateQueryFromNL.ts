...
CREATE TABLE "circunstancia_contacto_1" (
	"id" INTEGER NOT NULL GENERATED ALWAYS AS IDENTITY UNIQUE,
	"nombre" INTEGER NOT NULL,
	PRIMARY KEY("id")
);
...
CREATE TABLE "continualidad_asistencial_1" (
	"id" INTEGER NOT NULL GENERATED ALWAYS AS IDENTITY UNIQUE,
	"nombre" VARCHAR2(255) NOT NULL,
	PRIMARY KEY("id")
);
...
CREATE TABLE "comunidad_autonoma_1" (
	"id" INTEGER NOT NULL GENERATED ALWAYS AS IDENTITY UNIQUE,
	"nombre" VARCHAR2(255) NOT NULL,
	PRIMARY KEY("id")
);
...
CREATE TABLE "POA_diagnostico_1" (
	"id" INTEGER NOT NULL GENERATED ALWAYS AS IDENTITY UNIQUE,
	"paciente_id" INTEGER NOT NULL,
